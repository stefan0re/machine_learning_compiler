...
class mini_jit::instructions::InstGen {
   public:
     ...
     * @return instruction.
     **/
    static uint32_t neon_ld1_scalar_index(simd_fp_t reg_dst, gpr_t reg_src, uint8_t lane_index);
     ...
     * @return instruction.
     **/
    static uint32_t neon_st1_scalar_index(simd_fp_t reg_dst, gpr_t reg_src, uint8_t lane_index);
